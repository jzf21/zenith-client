...
import SidebarLinkGroup from "./Sidebarsidelinks";
...
//   }, [sidebarExpanded]);
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-9999 flex h-screen w-[20%] flex-col overflow-y-hidden bg-blue-500 duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
