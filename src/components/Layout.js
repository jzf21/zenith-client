...
const DefaultLayout = ({children}) => {
  ...
  return (
    <>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center justify-start">
              ...
              <a href="https://flowbite.com" className="flex ml-2 md:mr-24">
                <img
                  src="https://placeholder.com/50x50?text=Logo"
                  className="h-8 mr-3"
                  alt="Zenith   Logo"
                />
      ...
      <aside
        id="logo-sidebar"
        className={`fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform  bg-white border-r border-gray-200  sm:translate-x-0 dark:bg-black dark:border-gray-700 `}
        aria-label="Sidebar"
      >
